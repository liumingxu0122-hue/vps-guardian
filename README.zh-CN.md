...
有关信任边界、数据流和组件职责，请阅读[架构说明](docs/zh-CN/ARCHITECTURE.md)；监控工作流参见 [Phase 4B 运维说明](docs/zh-CN/PHASE4B.md)。
...
- 验证更大规模多 VPS 集群的长期运行
- 增加基于 CSR 的注册 bootstrap
- 完成隔离的哪吒运行时基准；未测量值保持 `Pending`
- 增加跨云恢复流程和生产部署指南
- Phase 4C 完成并通过 staging 验收后，再单独发布 `v0.3.0-alpha.1`
