...
def test_agent_ca_private_key_uses_service_isolated_runtime_secret() -> None:
    ...
    assert '"$agent_ca_private_key" agent-ca.key' in script
    assert "runtime}/controller/agent-ca.key" in compose
